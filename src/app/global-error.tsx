...
export default function GlobalError(){
 return <html lang="en" translate="no" className="notranslate"><head><meta name="google" content="notranslate" /></head><body style={{margin:0,background:'#f8fafc',fontFamily:'sans-serif',color:'#1e293b'}}>
