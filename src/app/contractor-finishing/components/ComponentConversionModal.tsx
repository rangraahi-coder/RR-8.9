...
export default function ComponentConversionModal({onClose,onSaved}:{onClose:()=>void;onSaved:()=>void}){
 ...
 return <div className="erp-modal-enter fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4"><form onSubmit={e=>{e.preventDefault();void save();}} className="bg-white rounded-2xl max-w-4xl w-full max-h-[92vh] overflow-auto">
