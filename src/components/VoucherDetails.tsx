...
const hidden=new Set(['id','legacy_id','request_payload','created_at','updated_at','created_by','updated_by','job_card_ids','job_card_refs','job_link_version']);
